...
Далее я доработала сборку, сделав ее параметризированной. Можно выбрать версию браузера Chrome, разрешение экрана, а также какие именно тесты будут запущены: 
- все тесты
- только тесты из раздела 'Навигация по сайту'
- только тесты из раздела 'Действия на странице похода'

![Запись экрана 2022-12-18 в 02 14 24](https://user-images.githubusercontent.com/109241600/208266640-e1a85277-dda7-4eb1-a934-571eb8144459.gif)
